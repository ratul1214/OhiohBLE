...
public class Peripheral extends Activity implements ServiceFragmentDelegate {
  ...
  public static  UUID CHARACTERISTIC_USER_DESCRIPTION_UUID ;
  ...
  DeviceUuidFactory duuidf;
  @Override
  protected void onCreate(Bundle savedInstanceState) {
  duuidf = new DeviceUuidFactory(this);
    CHARACTERISTIC_USER_DESCRIPTION_UUID = duuidf.getDeviceUuid();
    CLIENT_CHARACTERISTIC_CONFIGURATION_UUID =  duuidf.getDeviceUuid();
...
Toast.makeText(this,CHARACTERISTIC_USER_DESCRIPTION_UUID.toString(),Toast.LENGTH_LONG);
  ...
  protected void onStart() {
    ...
    if (mBluetoothAdapter.isMultipleAdvertisementSupported()) {
      ...
      mAdvStatus.setText(CHARACTERISTIC_USER_DESCRIPTION_UUID.toString());
    } else {
